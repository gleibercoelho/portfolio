        ...
        <ContactComponentBox>
            ...
            <div className="MapNFormBox">
                ...
                transition={{ duration: 1, delay: .75 }}   className="FormBox">
                    ...
                    <form onSubmit={handleSubmit}>
                        <input id="name" type="text" value={name} onChange={(e) => setName(e.target.value)} placeholder="Nome" required />
                        <input id="email" type="email" value={email} onChange={(e) => setEmail(e.target.value)} placeholder="Email" required />
                        <textarea id="message" value={message} onChange={(e) => setMessage(e.target.value)} placeholder="Mensagem" required />
                ...
                transition={{ duration: 1, delay: .75 }}   className="MapBox">
                    <p>Onde eu moro? <span> Santa Luzia, MG.</span></p>
                    <iframe
            ...
            <div  className="ContactWayBox">
                <div  className="SubContactOne">
                    <p>Me mande um email <a href="mailto:gleiberfelipe@hotmail.com" target="_blank"><span>gleiberfelipe@hotmail.com</span></a> <a className="copy" href="#" onClick={copyEmail}><IoCopy /></a></p>
                    <p>Me mande um whatsapp <a href="https://wa.me/31991326989?text=Olá,%20Gleiber.%20Acabei%20de%20ver%20seu%20portfólio." target="_blank"><span><IoLogoWhatsapp className="zapzap" /></span></a> <a className="copy" href="#" onClick={copyNumber}><IoCopy /></a></p>
                </div>
                <div className="SubContactTwo">
                    <p>Se conecte comigo no <a href="https://www.linkedin.com/in/gleiber-coelho-40ba6927/" target="_blank"><span>LinkedIn</span></a> <a className="copy" href="#" onClick={copyLinkedin}><IoCopy /></a></p>
                    <p>Conheça e/ou me siga no <a href="https://github.com/gleibercoelho" target="_blank"><span>GitHub</span></a> <a className="copy" href="#" onClick={copyGithub}><IoCopy /></a></p>
                </div>
            </div>
            </RevealTwo>
            <ToastContainer />
